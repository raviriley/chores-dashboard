...
const chores = [
  ...
  {
    subject: "Sink, Drying Rack, & Dining Table",
    instructions:
  ...
  {
    subject: "Kitchen Floors & Trash / Recycling",
    instructions:
